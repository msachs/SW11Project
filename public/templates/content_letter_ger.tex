...
%%% sender's place
\setkomavar{place}{%
<mindshare:content>Absendeort</mindshare:content>
}

%%% sender's address
\setkomavar{fromaddress}{%
<mindshare:content>Absender Addresse</mindshare:content>\\ 
<mindshare:content>Absender PLZ/Ort</mindshare:content>
}

%%% sender's email
%%% requires fromemail set "true"
\setkomavar{fromemail}{%
<mindshare:content>Absender E-Mail</mindshare:content>
}

%%% sender's name
\setkomavar{fromname}{%
<mindshare:content>Absender Vorname</mindshare:content>~<mindshare:content>Absender Nachname</mindshare:content>
}

%%% sender's phone number
%%% requires fromphone set "true"
\setkomavar{fromphone}{%
<mindshare:content>Absender Telefonnr.</mindshare:content>
}
...
\setkomavar{fromfax}{%
<mindshare:content>Absender Fax</mindshare:content>
}

%%% custom date
 \setkomavar{date}{%
<mindshare:content>Datum</mindshare:content>
 }
...
%%% subject
\setkomavar{subject}{%
<mindshare:content>Betreff</mindshare:content>
}
...
\begin{letter}{%
<mindshare:content>Empfaenger Vorname</mindshare:content>~<mindshare:content>Empfaenger Nachname</mindshare:content>\\ 
<mindshare:content>Empfaenger Addresse</mindshare:content>\\ 
<mindshare:content>Empfaenger PLZ/Ort</mindshare:content>
}
...
<mindshare:content>Briefinhalt</mindshare:content>
