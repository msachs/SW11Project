...
%%% sender's place
\setkomavar{place}{%
<mindshare:content>SenderPlace</mindshare:content>
}

%%% sender's address
\setkomavar{fromaddress}{%
<mindshare:content>SenderStrasseHausnr</mindshare:content>\\ 
<mindshare:content>SenderPosleitzahlStadt</mindshare:content>
}

%%% sender's email
%%% requires fromemail set "true"
\setkomavar{fromemail}{%
<mindshare:content>SenderEmail</mindshare:content>
}

%%% sender's name
\setkomavar{fromname}{%
<mindshare:content>SenderVorname</mindshare:content><mindshare:content>SenderNachname</mindshare:content>
}

%%% sender's phone number
%%% requires fromphone set "true"
\setkomavar{fromphone}{%
<mindshare:content>SenderTel</mindshare:content>
}
...
\setkomavar{fromfax}{%
<mindshare:content>SenderFax</mindshare:content>
}
