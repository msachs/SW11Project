...
\begin{cv}{curriculum vit{\ae}}
  ...
  \item [\de{Geboren~am}\en{Date of Birth}] \de{<mindshare:content>Geburtsdatum</mindshare:content>}\en{Jannuary~1\raisebox{1ex}{st}~19xx}
  ...
  \item [\de{Spezielle fachliche Interessen}\en{Special Interests}] ~
    ...
    \item <mindshare:content>Spezielle fachliche Interessen</mindshare:content>
  ...
  \item \de{<mindshare:content>Studium und Weiterbildung</mindshare:content>}
  ...
  \item \de{<mindshare:content>Publikationen</mindshare:content>}
